package com.edubio77.mvc.models;
...
@Table(name="books")
public class Book {
	@Id //Establece una tabla en la base de datos.
    @GeneratedValue(strategy = GenerationType.IDENTITY)  //Establece este campo con un valor auto incrementable.
    private Long id;
