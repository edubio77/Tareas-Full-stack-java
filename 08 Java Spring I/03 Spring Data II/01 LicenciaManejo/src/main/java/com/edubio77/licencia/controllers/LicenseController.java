...
public class LicenseController {
	...
	public String newLicense(@ModelAttribute("licenseReal") License license, Model model) {
		...
		List<Person> listapersonas = personService.allPerson();
		model.addAttribute("listapersonas", listapersonas);
		ArrayList<String> states = new ArrayList<String>(Arrays.asList("Cunco", "Padre las Casas", "Temuco"));
	...
	public String addLicense(@Valid @ModelAttribute("licenseReal") License license, BindingResult result) {
		if (result.hasErrors()) {
			...
			String number = licenseService.crearNumeroLicencia();
